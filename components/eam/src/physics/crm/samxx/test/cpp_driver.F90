...
#endif  
  ! for shoc inputs
    crm_input%shf(icrm)               = read_crm_input_shf        (icrm)
    crm_input%cflx(icrm)              = read_crm_input_cflx       (icrm)
    crm_input%wsx(icrm)               = read_crm_input_wsx        (icrm)
    crm_input%wsy(icrm)               = read_crm_input_wsy        (icrm)

    crm_input%sl(icrm,:)              = read_crm_input_sl         (:,icrm)
    crm_input%zm(icrm,:)              = read_crm_input_zm         (:,icrm)
    crm_input%omega(icrm,:)           = read_crm_input_omega      (:,icrm)
    crm_input%t_prev(icrm,:)          = read_crm_input_t_prev     (:,icrm)
    crm_input%qv_prev(icrm,:)         = read_crm_input_qv_prev    (:,icrm)
    crm_input%relvar(icrm,:)          = read_crm_input_relvar     (:,icrm)
    crm_input%nccn_prescribed(icrm,:) = read_crm_input_nccn_prescribed(:,icrm)
    !\
    ! for shoc inputs
    !/
    crm_input%tke_zt(icrm,:)          = read_crm_input_tke_zt      (:,icrm)
    crm_input%wthv(icrm,:)            = read_crm_input_wthv        (:,icrm)
    crm_input%tkh(icrm,:)             = read_crm_input_tkh         (:,icrm)
    crm_input%tk(icrm,:)              = read_crm_input_tk          (:,icrm)
    crm_input%alst(icrm,:)            = read_crm_input_alst        (:,icrm)
    crm_input%qtracers(icrm,:,:)      = read_crm_input_qtracers    (:,icrm,:)
    crm_input%npccn(icrm,:)           = read_crm_input_npccn       (:,icrm)
    crm_input%ni_activated(icrm,:)    = read_crm_input_ni_activated(:,icrm)
    crm_input%ast(icrm,:)             = read_crm_input_ast         (:,icrm)
